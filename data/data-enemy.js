var enemyDataArr = [
  {
    ...
    "info": "하아... 이 예쁜 애의 이름은 나이트 칙입니다. 예쁘지만 더 예쁜 폴른이를 잡아먹은 무서운 녀석들이에용. 쉬지않고 기관총을 난사하니 주의해 주세용~!<br><br>-보고자 그렘린입니당!",
    "CRT": "5"
  },
  {
    "name": "나이트 칙 실더",
    ...
    "info": "이 자식들 짜증나 방패를 들고 앞을 자꾸 가로막거든? 다행히 머리가 나빠서 바로 뒤만 가로 막지만⋯ 어쨌든 이 녀석들이 방어 자세를 취하기 전에 뒤를 정리해 두라고!<br><br>-보고자 그리폰",
    "CRT": "5"
  },
  {
    "name": "나이트 칙 런처",
    ...
    "info": "흔히 볼 수 있는 미사일로 무장한 철충. 무조건 앞으로 돌격하는 모습이 브라우니와 비슷합니다.<br><br>-보고자 레프리콘"
  },
  {
    "name": "나이트 칙 디텍터",
    "img": "NightChickDE",
    ...
    "type": "경장 지원기",
    "info": "그 아이는 별로 위험한 아인 아니거든? 근데 자꾸 우리를 방해하는 공격을 하니까 다른 애들이랑 있으면 주의해야 하거든? 맞으면 다른 철충한테 지원 요청하는 못된 아이니까 혼내줘야행! 누나 보고 있을께~!<br><br>-예쁜 누나 포츈이 보고해용~!",
    "CRT": "5"
  },
  {
    "name": "나이트 칙 디텍터 G",
    ...
    "skills": [
      {
        ...
        "img": "TeamDefDeBuff",
        "range": "5",
        "description": "교란 파장을 발산해 $(0.1) 보호 무시 피해를 주고, 3라운드 동안 표식 / 받는 피해 증가 / 적중 / 회피 감소 효과를 줍니다. 스킬 사용 시, 회피가 증가합니다. 기동형 적에게는 효과가 없습니다.",
        "areadata": [
          2,
          4,
          5,
  ...
  },
  {
    ...
    "type": "기동 지원기",
    "info": "저 망할 날파리들! 엄청 빨라서 잘 맞지도 않고 뭐만 하려하면 방해해서 진짜 짜증나는 녀석들이야. 백발백중인 미호가 필요해!<br><br>-스틸 드라코",
    "resist": [
      0,
      0,
      0
  ...
  },
  {
    ...
    "info": "얘는 원래는 나처럼 일하던 애였던 것 같아. 멀리 있는 적을 갈고리로 당겨오니 주의하는 게 좋아. 나처럼 힘들게 사는 애니 편히 보내 주는 게 좋을 지도...<br><br>-더치걸",
    "CRT": "5"
  },
  {
    "name": "나이트 칙 캐논",
    ...
    "info": "박격포로 무장한 나이트 칙인데... 별 거 아닌 폭죽이나 쏴대는 벌레야. 아, 약한 애들한텐 무서우려나?<br><br>-메이 보고함",
    "CRT": "5"
  },
  {
    "name": "칙 스나이퍼",
    ...
    "info": "엄폐와 위장 능력이 좋음. 빠르게 한 방으로 처리하는 게 좋을 것 같음.<br><br>-발키리",
    "CRT": "12.5"
  },
  {
    "name": "케미컬 칙",
    ...
    "info": "냄새 나고 이상한 액체를 뿌려. 더럽고 음란해. 그 이상한 액을 뒤집어 쓴 애들은 한 동안 근처에 못 오게 했어. 특히 스틸 드라코는⋯<br><br>-보고자 미호",
    "CRT": "10"
  },
  {
    "name": "저거너트",
    ...
    "info": "성격이 나빠 보이는 철충인 거에요. 공격을 시작하면 끝까지 공격하거든요. 그래서 공중 부대로 유인을 하는 게 좋을 것 같아요. 그 덩치로 다른 철충들을 보호하지 못하게요.<br><br>-블랙 하운드",
    "CRT": "10"
  },
  {
    "name": "레기온",
    ...
    "CRT": "5",
    "info": "공중의 적만 집요하게 노리니 공중 부대 운용 시 주의해! 구리게 보이는 점착제를 떼느라 이틀이나 고생했어. 그거 묻으면 진짜 아싸처럼 보이니 주의하라고!<br><br>-실피드"
  },
  {
    "name": "재퍼",
    "img": "Zapper",
    ...
    "CRT": "5",
    "info": "호전성이 낮은 개체에요. 건드리지만 않으면 공격하지 않으니 주의해 주세요. 고압 전류 공격을 하니까요. 설마 제가 대신 맞아서 찌릿찌릿에 눈 뜨는 걸 바라는 건 아니겠죠?<br><br>-보고자 블랙 리리스"
  },
  {
    "name": "팔랑스",
    "img": "Phalangites",
    ...
    "type": "경장 보호기",
    "CRT": "10",
    "info": "각이 잡힌 대열로 행군하는 철충입니다. 철충 놈들 중엔 드물게 군기가 들어있지 말입니다. 딱 밀착해서 서로서로를 보호하는 녀석들이니 진형을 아작내는 게 중요하지 말임다.<br><br>-블러디팬서",
    "resist": [
      40,
      40,
      40
  ...
  },
  {
    ...
    "CRT": "10",
    "info": "작은 부대의 지휘관 역할을 하는 철충으로 보입니다. 주변 철충에게 일제 공격을 지시하는 정황이 포착되었군요. 부하들이 파괴되면 경계를 하는 것 같아요. 먼저 처리하는 게 좋을 것으로 보입니다.<br><br>-37식 다이카"
  },
  {
    "name": "매머드",
    "img": "Mammoth",
    ...
    "info": "한 방이 엄청나게 무서운데다 장갑도 두꺼워서 장갑 사이에 치명타를 먹이거나 아니면 관통할 수 있는 무기가 좋아 보이네. 뭐, 못 피하면 죽으니까 조심하라고.<br><br>-보고자 샌드걸"
  },
  {
    "name": "와습",
    "img": "Wasp",
    ...
    "CRT": "10",
    "info": "누가 이 자식에게 이 뿔침을 달아준 거야? 물론 나처럼 빠르진 않지만 나보다 느린 애들은 전부 조심하도록 해. 제법 빠른 속도로 돌격을 하니 말이야.<br><br>-슬레이프니르"
  },
  {
    "name": "스캐럽",
    "img": "Scarab",
    ...
    "CRT": "10",
    "info": "이상한 구조인데 잘도 나는 거 있지? 나 저거 꼭 분해하고 싶으니까 잡히면 나한테 보내 줘야 해! 겁쟁이라 무서우면 방어를 하니까 빨리 해치우는 게 좋아.<br><br>-보고자 닥터"
  },
  {
    "name": "아쿠아 칙",
    "img": "NightChickAQ",
  ...
  },
  {
    ...
    "type": "경장 공격기",
    "info": "후아~ 촙 메이커로 때리니 갑자기 날뛰어서 큰일 날 뻔 했어요! 전기에 반응하는 것 같던데...아 참! 서펀트씨가 물을 뿌린 녀석은 갑자기 자폭해버리더라구요.<br><br>-켈베로스 보고함 "
  },
  {
    "name": "칠러",
    "img": "Chiller",
  ...
  },
  {
    ...
    "type": "",
    "info": "조준은 엉망이지만 화력은 강력하니 주의해 주세요. 제 풀에 지쳐 가동을 멈추니 잘 피하기만 해도 될 거에요.<br><br>-블랙 하운드 보고함"
  },
  {
    "name": "경비용 펍 헤드",
    "img": "PuppHead",
  ...
  },
  {
    ...
    "type": "",
    "info": "이 녀석과 같이 다니는 적들은 신속하게 움직이는 것 같군. 신속히 처리하는 것이 좋겠어.<br><br>-칸 보고함"
  },
  {
    "name": "경비용 램파트",
    "img": "Rampart",
  ...
  },
  {
    ...
    "type": "",
    "info": "불리해지면 동료에게 지원 요청을 하는 약삭빠른 녀석이야. 방어하기 시작하면 반격하니 주의해.<br><br>-칼리스타 보고함"
  },
  {
    "name": "경비용 드론",
    "img": "Drone",
  ...
  },
  {
    ...
    "type": "",
    "info": "지상군 대응용으로 개조된 드론인거 같아. 대공 능력은 없는 것 같네. 그나저나 폭탄 배송이라니… 캐치 프레이즈로 적합한거 같기도…<br><br>-익스프레스 76 보고함"
  },
  {
    "name": "경비용 AMG-11",
    "img": "AMG11",
  ...
  },
  {
    ...
    "type": "",
    "info": "오~ 이 녀석들 왠지 마음에 드는데? 몇 대 가져가서 네리의 부하로 쓰면 되겠어! 네리 대신 일하게 해야지!<br><br>-네레이드 보고함"
  },
  {
    "name": "양산형 스팅어",
    "img": "Stinger",
  ...
  },
  {
    ...
    "type": "",
    "info": "극지용 스팅어? 묘한 친근감이 느껴지네요. 적이 보호하기 전에 빠르게 처치하는게 좋을거에요. 견딜만하다고 방심하다간 큰일날 수 있어요.<br><br>-님프 보고함"
  },
  {
    "name": "양산형 기간테스",
    "img": "Gigantes",
  ...
  },
  {
    ...
    "type": "",
    "info": "거점 방어에 특화된 모델인건가? 행동은 굼떠보이지만 좀처럼 빈틈이 안보여. 하지만 내 소우 피쉬라면 해결할 수 있을걸?<br><br>-트리아이나 보고함"
  },
  {
    "name": "양산형 셀주크",
    "img": "Seljuq",
  ...
  },
  {
    ...
    "type": "",
    "info": "화력은 일반형 셀주크보다 떨어지지만 장갑은 더 향상된 것 같아요. 공격을 계속 허용하면 이쪽 움직임에 적응하니 방어 능력이 좋은 소대로 제압하는게 좋을 것 같네요.<br><br>-세이렌 보고함"
  },
  {
    "name": "칙 쿼터마스터",
    "img": "NightChickQM",
  ...
  },
  {
    ...
    "type": "경장 공격기",
    "info": "지휘관 역할을 하는 철충인가 보네… 저렇게 무리하게 부하들을 다루면 안 좋을 것 같은데… 역시 적당히 하는 게 최고야...<br><br>-이프리트 보고함"
  },
  {
    "name": "철충 사념체 (보병)",
    "img": "ProgramMobTS",
  ...
  },
  {
    ...
    "info": "빅 칙과는 달라! 빅 칙과는! 뭐로 만든지는 몰라도 장갑이 차원이 다르니 나 같은 대 장갑 요원이 없으면 꽤나 곤란할걸?<br><br>-불가사리 보고함",
    "CRT": "5"
  },
  {
    "name": "강화형 빅 칙",
  ...
  },
  {
    ...
    "info": "요원 암살용 철충 연결체. 빠르고 민첩하다. 나와 우리 부대처럼 기동전이 가능한 부대가 맡는 게 좋을 것 같군. 포획이든 파괴든 쉽지 않다.<br><br>-칸",
    "CRT": "15"
  },
  {
    "name": "트릭스터 (5-4)",
  ...
  },
  {
    ...
    "CRT": "25",
    "info": "고속 교란용 연결체. 지휘 능력이 제법 뛰어나 대량의 철충 부대와 함께 다니기 때문에 주의하는 게 좋아. 보기보다 겁쟁이라 위협을 느끼면 닥치는대로 전격탄을 난사하니 대비하는 작전을 세우면 그럭저럭 상대할 만 할 거야.<br><br>-레오나"
  },
  {
    "name": "광폭화 레이더",
    "img": "Raider_B04_CH",
  ...
  },
  {
    ...
    "CRT": "12.5",
    "info": "제 해킹으로 성능이 저하된 상태지만, 에너지 충전이 완료되면 여전히 무시무시한 공격을 할 거에요. 충전을 막기 위해 제네레이터를 공격하는 것도 좋겠네요. 본체는 공격 직후를 노리면 더 많은 타격을 줄 수 있을 것 같네요.<br><br>-스카디"
  },
  {
    "name": "언더왓쳐 센서 (5-8)",
    ...
    "CRT": "0",
    "info": "조준용 센서가 달린 파츠네요. 피해를 주거나 파괴하면 공격을 피하기 쉬워질거에요.<br><br>-스카디"
  },
  {
    "name": "언더왓쳐 암 (5-8)",
    ...
    "CRT": "15",
    "info": "언더왓쳐의 공격용 암 파츠네요. 대공 기능이 있는 것 같으니 주의하세요.<br><br>-스카디"
  },
  {
    "name": "언더왓쳐 제네레이터 (5-8)",
    ...
    "CRT": "0",
    "info": "에너지 공급용 제네레이터네요. 계속 공격해보면 에너지 공급을 멈출 수 있을 것 같네요.<br><br>-스카디"
  },
  {
    "name": "언더왓쳐 (5-8Ex)",
    "img": "UnderWatcher_B05",
    ...
    "CRT": "15",
    "info": "에너지 충전이 완료되면 무시무시한 공격을 할 거에요. 충전을 막기 위해 제네레이터를 공격하는 것도 좋겠네요. 본체는 공격 직후를 노리면 더 많은 타격을 줄 수 있을 것 같네요.<br><br>-스카디"
  },
  {
    "name": "언더왓쳐 센서 (5-8Ex)",
    "img": "UnderWatcherSensor_B05",
  ...
  },
  {
    ...
    "type": "",
    "info": "큿… 제 레이더로도 포착하기 어려운 상대네요. 최대 충전 상태가 되면 강력한 공격을 하니 주의하시길. 상태를 보니 큰 피해를 입으면 어떤 꼬맹이처럼 성대하게 폭발할 것 같군요.<br><br>-나이트 앤젤 보고함"
  },
  {
    "name": "에너지 컨덴서",
    "img": "RocCGenerator",
    ...
    "type": "",
    "info": "전력을 공급하기 위한 장치네요. 웬만한 충격으론 금방 복원되니 무력화되었을 때 본체를 노리는게 좋을 것 같아요.<br><br>-세이렌 보고함"
  },
  {
    "name": "로크 (최대 충전) (챌린지)",
    "img": "RocC_Charge",
  ...
  },
  {
    ...
    "info": "일반 칙 실더보다 큰 방패 때문에 뒤의 대상들을 공격하기 위해서는 더 용맹한 정신이 필요하다. 나이트 칙 실더와 헷갈리지 않도록 지휘 콘솔을 반드시 확인해야 함.<br><br>-마리",
    "CRT": "5"
  },
  {
    "name": "강화형 칙 실더",
  ...
  },
  {
    ...
    "type": "경장 지원기",
    "info": "강한 방패 전파를 쏴서 귀찮긴 한데, 냉기에 약한지 기온이 내려가면 이상을 일으켜 오히려 도움이 되는 것 같아.<br><br>-엠프리스 보고함",
    "resist": [
      50,
      -35,
      75
  ...
  },
  {
    ...
    "info": "스카우트와 비슷해요. 탄종은 좀 다른 것 같지만. 뭘 쏘길래 모두 피해냈어요. 별로 정확하진 않은 것 같군요. 주변 철충들과 대열을 갖추려고 하면 주의해 주세요.<br><br>-페로 드림"
  },
  {
    "name": "지원형 스카우트",
    "img": "Scout",
  ...
  },
  {
    ...
    "type": "경장 지원기",
    "info": "화력이 좀 더 강한 레기온이야. 난 전혀 구분이 안 가는데 에밀리는 잘 구분하더라구. 이상한 데서 재주가 좋다니까...아! 지휘관 철충과의 연계 공격은 특히 주의해야 해!<br><br>-파니 보고함"
  },
  {
    "name": "엘리트 센츄리온",
    "img": "Centurion",
  ...
  },
  {
    ...
    "type": "",
    "info": "치즈는 역시 프랑스 산이 최고에요!<br><br>-운디네"
  },
  {
    "name": "퐁 레베크",
    "img": "Undine",
  ...
  },
  {
    ...
    "type": "",
    "info": "슈~퍼한 네리네리를 이길 수 있을까!?<br><br>-네레이드"
  },
  {
    "name": "네리의 부하",
    "img": "AMG11AA",
  ...
  },
  {
    ...
    "type": "",
    "info": "속이 아파오기 시작했어요… 제가 안 보면 대체 무슨 일을 할지...<br><br>-세이렌"
  },
  {
    "name": "그럼요~",
    "img": "SireneCannon",
  ...
  },
  {
    ...
    "type": "",
    "info": "그럼요…? 오늘의 암구호인 건가요?<br><br>-운디네"
  },
  {
    "name": "그럼~요!",
    "img": "Nereid",
    ...
    "type": "",
    "info": "얼른 처리하고 놀러 가야지!<br><br>-네레이드"
  },
  {
    "name": "케미컬 칙 Type-X",
    "img": "NightChickCMP",
    ...
    "type": "경장 공격기",
    "info": "히익… 다신 보기 싫을 정도로 징그러웠어요…... 불에는 약한지 불을 붙이니 폭발해서 깜짝 놀랐네요.<br><br>-뽀끄루 보고함",
    "resist": [
      0,
      99,
      99
  ...
  },
  {
    ...
    "type": "중장 공격기",
    "info": "화력이 뛰어나지만 전기로 센서를 일시적으로 고장낼 수 있는거 같아요. 보조 무장은 약하지만 정밀하니 주의하세요.<br><br>-레아 보고함"
  },
  {
    "name": "강화형 저거너트",
    "img": "Juggernaut",
  ...
  },
  {
    ...
    "type": "경장 공격기",
    "info": "가까이 오면 자폭해서 접근하기 전에 처리해야 하는데... 엄청나게 잽싸서 조준 보조 없이는 맞추기 힘들어요. 과열 상태가 되면 큰 폭발을 일으키니 이걸 노려보는 게 어떨까요?<br><br>-베라 보고함"
  },
  {
    "name": "스토커 (1-4Ex)",
    "type": "경장 공격기",
    ...
    "skills": [
      {
        ...
        "range": "5",
        "AP": "4",
        "description": "대상에게 $(1.1) 보호 무시 피해를 줍니다. 치명타 시 피해량이 증가하며, 자신이 전열인 경우 대상의 방어막 / 피해 감소 효과를 무시합니다.",
        "areadata": [
          5
        ]
      },
  ...
  },
  {
    ...
    "skills": [
      ...
      },
      {
        ...
        "range": "4",
        "AP": "6",
        "description": "포획탄을 던져 $(0.8) 피해를 주고, 50% 확률로 3라운드 동안 대상을 이동 불가 / 공격력 / 치명타 / 회피 / 행동력 감소 상태로 만듭니다. 스킬 사용 시, 3라운드 동안 자신의 적중이 증가합니다.",
        "areadata": [
          5
        ]
      },
    ...
    "skills": [
      {
        ...
        "range": "5",
        "AP": "4",
        "description": "대상에게 $(1.1) 피해를 줍니다. 치명타 시, 75% 확률로 대상의 강화 효과를 해제하며 5라운드 동안 회피를 감소시키고 받는 피해를 증가시킵니다.",
        "areadata": [
          5
        ]
      },
  ...
  },
  {
    ...
    "CRT": "15",
    "info": "주위 철충들에게 명령을 내리는 칙 커맨더는 마치 훈련 교관처럼 느껴집니다. 철충들이 쓰러질 때마다 분노가 끓어올라 강해지고 쓰러진 철충들을 다시 일으켜 세울 수 있는 막강한 능력이 있습니다. 하지만 적군이 쓰러졌을 시 분노는 가라 않고 약해지는 것으로 보아 어쩌면... 아군의 희생이 필요할지도 모릅니다.<br><br>보고자 ???",
    "skills": [
      {
        "title": "askill1",
        "type": "active",
      ...
      },
      {
        ...
        "range": "0",
        "AP": "0",
        "description": "철충들이 낙오(파괴)될 때마다 <복수심>이 적용 되고 낙오한 철충이 10마리가 될 시 <끓어오르는 분노> 상태로 <분노의 칙 파이널 어택> 스킬을 사용합니다. 적 군이 사망 시 <사라진 분노>가 적용 되고 3라운드 동안 철충들이 낙오(파괴)되더라도 <복수심>이 발동되지 않습니다.<br><br>복수심 : 공격력 / 방어력 / 적중률 증가<br>끓어오르는 분노 : 해당 상태가 적용 되있을 시 <분노의 칙 파이널 어택> 스킬 사용<br>사라진 분노 : 공격력 / 방어력 감소<br>낙오자 발생 : 철충들이 낙오(파괴) 된 상태",
        "areadata": [
          5
        ]
      },
      {
        ...
        "range": "0",
        "AP": "0",
        "description": "라운드 개시 시 철충들을 일사불란하게 지휘하기 위해 <지휘 집중>이 적용 됩니다.<br><br>지휘 집중 : 해제 불가의 해로운 효과 저항 적용",
        "areadata": [
          5
        ]
      },
  ...
  },
  {
    ...
    "CRT": "2.5",
    "info": "솔져 칙은 칙 커맨더의 명령에 따라 움직이며 자신의 몸체를 던져 칙 커맨더를 보호하기도 합니다. 그리고 칙 커맨더가 있는 한 쓰러지지 않고 근성으로 일어나 다시 싸웁니다.<br><br>보고자 ???",
    "skills": [
      {
        "title": "askill1",
        "type": "active",
